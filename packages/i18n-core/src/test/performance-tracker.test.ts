...
import { PerformanceTracker, type PerformanceTrackerConfig, type PerformanceMetrics } from "../lib/plugins/performance-tracker.js";
...
describe("PerformanceTracker", () => {
  ...
  describe("memory management", () => {
    it("should limit total entries to prevent memory leak", () => {
      const plugin = tracker.createTracker ? tracker : new PerformanceTracker({ maxSlowEntries: 10000 });
