...
import { MissingKeyReporter, type MissingKeyReporterConfig } from "../lib/plugins/missing-key-reporter.js";
...
describe("Console Logger Plugin", () => {
  ...
  describe("onError", () => {
    it("should log errors with context", () => {
      ...
      const plugin = createConsoleLogger();
      plugin.onError(new Error("test error"), { key: "test", locale: "en" } as any);
      expect(spy).toHaveBeenCalledWith(
